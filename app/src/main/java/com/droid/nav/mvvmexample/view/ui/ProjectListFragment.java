...
import com.droid.nav.mvvmexample.di.Injectable;
 ...
 */
public class ProjectListFragment extends Fragment  implements Injectable,LifecycleOwner {
    ...
    private ProjectClickCallback projectClickCallback= project -> {
